...
RSpec.describe StudiosController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all studios as @studios" do
      ...
      expect(assigns(:studios)).to eq([studio])
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created studio as @studio" do
        ...
        expect(assigns(:studio)).to be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved studio as @studio" do
        post :create, {:studio => invalid_attributes}, valid_session
        expect(assigns(:studio)).to be_a_new(Studio)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested studio" do
        studio = Studio.create! valid_attributes
        put :update, {:id => studio.to_param, :studio => new_attributes}, valid_session
        studio.reload
      ...
      it "redirects to the studio" do
        studio = Studio.create! valid_attributes
        put :update, {:id => studio.to_param, :studio => valid_attributes}, valid_session
        expect(response).to redirect_to(studio)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the studio as @studio" do
        studio = Studio.create! valid_attributes
        put :update, {:id => studio.to_param, :studio => invalid_attributes}, valid_session
        expect(assigns(:studio)).to eq(studio)
      end
